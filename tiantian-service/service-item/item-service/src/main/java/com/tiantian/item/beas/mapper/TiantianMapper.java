package com.tiantian.item.beas.mapper;
...
public interface TiantianMapper<T> {
     ...
     * @return
     */
    @DeleteProvider(type = TiantianMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @InsertProvider(type = TiantianMapperProvider.class, method = "dynamicSQL")
    int insert(T record);
     ...
     * @return
     */
    @UpdateProvider(type = TiantianMapperProvider.class, method = "dynamicSQL")
