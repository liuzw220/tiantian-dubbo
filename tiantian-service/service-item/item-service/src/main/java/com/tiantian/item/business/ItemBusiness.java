...
public class ItemBusiness extends BaseBusiness<Item>  {
    ...
    public EasyUIResult queryListPage(Integer pageIndex, Integer pageSize) {
        Item item=new Item();
        PageInfo<Item> listPage = super.queryListPage(item, pageIndex, pageSize);
        List<Item> list = listPage.getList();
        return new  EasyUIResult(listPage.getTotal(),listPage.getList());
    }
