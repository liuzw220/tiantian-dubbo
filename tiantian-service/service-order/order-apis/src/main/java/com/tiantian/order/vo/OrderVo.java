...
public class OrderVo {
	...
	private List<OrderItemVo> orderItems;//商品详情
	
	private OrderShippingVo orderShipping; //物流地址信息
	...
	public OrderShippingVo getOrderShipping() {
		return orderShipping;
	}
	public void setOrderShipping(OrderShippingVo orderShipping) {
