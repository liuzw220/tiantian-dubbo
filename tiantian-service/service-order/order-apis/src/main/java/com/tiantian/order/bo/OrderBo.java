...
public class OrderBo {
	...
	@NotEmpty
	private List<OrderItemBo> orderItems;//商品详情
	
	private OrderShippingBo orderShipping; //物流地址信息
	...
	public OrderShippingBo getOrderShipping() {
		return orderShipping;
	}
	public void setOrderShipping(OrderShippingBo orderShipping) {
